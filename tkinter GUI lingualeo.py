...
label_word_nmbr.grid(column=1, row=2)
...
def click_button(option, button):
...
checkbutton = ttk.Checkbutton(first_frame, text='переключать слова автоматически')
checkbutton.grid(column=1, row=1)
action_button1 = ttk.Button(first_frame, text=option1, command=lambda: click_button(option1, action_button1))
action_button1.grid(column=0, row=2)

action_button2 = ttk.Button(first_frame, text=option2, command=lambda: click_button(option2, action_button2))
action_button2.grid(column=0, row=3)

action_button3 = ttk.Button(first_frame, text=option3, command=lambda: click_button(option3, action_button3))
